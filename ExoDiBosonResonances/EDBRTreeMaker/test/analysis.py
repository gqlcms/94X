...
process.jetSequence = cms.Sequence(process.substructureSequence +
                               ...
                               #    process.packedPatJetsAK8PFPuppiSoftDrop +
                               #    process.selectedUpdatedPatJetsAK8WithPuppiDaughters)
...
#jetToolbox(process, 'ak8', 'dummySeqAK8', 'out',
           ...
           addSoftDrop=True, addSoftDropSubjets=True, subJETCorrPayload='AK4PFPuppi', subJETCorrLevels=JETCorrLevels   # must add soft-drop
)
...
#jetsAK8puppi = "updatedPatJetsTransientCorrectedAK8WithDeepTags"
...
'/store/mc/RunIISummer16MiniAODv3/ttZJets_13TeV_madgraphMLM-pythia8/MINIAODSIM/PUMoriond17_94X_mcRun2_asymptotic_v3-v1/120000/FEB8D23F-B7D0-E811-868F-0CC47A0AD6C4.root'
